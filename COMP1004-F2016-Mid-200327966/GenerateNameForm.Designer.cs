namespace COMP1004_F2016_Mid_200327966
{
    partial class GenerateNameForm
    {
        ...
        //randomly selects a name from the list box and puts them in the text boxes
        public void GenerateNames()
        {

            System.Random name = new System.Random();

            FirstNameListBox.SelectedIndex = name.Next(0, 49);
            LastNameListBox.SelectedIndex = name.Next(0, 49);

            

           FirstNameTextBox.Text = System.Convert.ToString(FirstNameListBox.Text);
           LastNameTextBox.Text = System.Convert.ToString(LastNameListBox.Text);
